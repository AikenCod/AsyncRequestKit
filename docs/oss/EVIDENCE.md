...
| Same-maintainer companion package | `AsyncRequestKitSSE` publicly declares an AsyncRequestKit dependency from `0.3.0` and has two release tags; this is not independent adoption | 2026-07-21 | https://github.com/AikenCod/AsyncRequestKitSSE/blob/main/Package.swift | Repository API and manifest inspection; companion repository has 1 star, 3 commits, and no public CI runs |
| Public independent adoption | Not observed | 2026-07-21 | https://github.com/AikenCod/AsyncRequestKit | Exact dependency-URL and Swift import searches found no qualifying public independent downstream repository; same-maintainer and non-public results were excluded |
